...
names(sig1d[[1]])
head(sig1d[[1]]$pert_iname) # perturbagen
head(sig1d[[1]]$cell_id)  # cell type
head(sig1d[[1]]$dn50_lm)  # some downregulated genes among the landmark
head(sig1d[[1]]$up50_lm)  # some upregulated genes among the landmark
}
```
